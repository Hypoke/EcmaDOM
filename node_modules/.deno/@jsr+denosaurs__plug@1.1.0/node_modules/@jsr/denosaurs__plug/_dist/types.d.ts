 ...
 */ export type OsRecord<T> = {
  [os in typeof Deno.build.os]: T;
};
/**
 * A record keyed by possible system architecture identifiers
 */ export type ArchRecord<T> = {
  [os in typeof Deno.build.arch]: T;
};
/**
 ...
 * this record.
 */ export type NestedCrossRecord<T> = Partial<OsRecord<T | Partial<ArchRecord<T>>> | ArchRecord<T | Partial<OsRecord<T>>>>;
/**
